            ...
            @if (filament()->auth()->check())
                ...
                >
                    ...
                    <x-filament::button
                        ...
                        :icon-alias="\Filament\View\PanelsIconAlias::USER_MENU_LOGOUT_BUTTON"
                        size="sm"
                        tag="button"
                        type="submit"
                    >
                ...
                <ul class="fi-topbar-nav-groups">
                    @foreach ($navigation as $group)
                        @php
                            ...
                            $groupTriggerIcon = $group->getIcon();
                            $groupTriggerIconValue = $groupExtraTopbarAttributeBag->get('data-topbar-trigger-icon');

                            if (filled($groupTriggerIconValue)) {
                                $groupTriggerIcon = \Filament\Support\Icons\Heroicon::tryFrom($groupTriggerIconValue) ?? $groupTriggerIconValue;
                            }
                        @endphp
